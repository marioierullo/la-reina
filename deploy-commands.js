...
(async () => {
	try {
		...
		const data = await rest.put(
			...
			{ body: commands },
            //Global application commands will be available in all the guilds 
            //your application has the applications.commands scope authorized in, 
            //and in direct messages by default.
